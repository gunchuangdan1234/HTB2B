...
import com.huatuo_b2b.htb2b.adapter.SendMsgListViewAdapter;
import com.huatuo_b2b.htb2b.adapter.SmiliesViewAdapter;
...
import com.huatuo_b2b.htb2b.common.ComparatorMsg;
            ...
            public void dataLoaded(ResponseData data) {
                if (data.getCode() == HttpStatus.SC_OK) {
                    ...
                    try {
                        ...
                        if (error != null) {
                            Toast.makeText(IMSendMsgActivity.this, error,
                    ...
                    // Toast.makeText(LoginActivity.this, "数据加载失败，请稍后重试",
                    // Toast.LENGTH_SHORT).show();;
                }
            }
        });
