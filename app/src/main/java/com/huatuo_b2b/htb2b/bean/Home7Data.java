...
//      product_company//生产厂家
    ...
    public Home7Data(String image, String goods_id, String goods_name,
    ...
    public static ArrayList<Home7Data> newInstanceList(String jsonDatas) {
        ArrayList<Home7Data> home7Datas = new ArrayList<Home7Data>();
        ...
        try {
            ...
            for (int i = 0; i < size; i++) {
                ...
                home7Datas.add(new Home7Data(image, goods_id, goods_name, goods_promotion_price, goods_image, goods_guige, goods_factory));
            }
