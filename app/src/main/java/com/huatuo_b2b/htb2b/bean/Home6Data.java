...
/**
 * Created by jinguo on 2016/4/5.
 */
public class Home6Data {
...
//            "rectangle2_data": "",
    ...
    public Home6Data(String title, String rectangle1_image, String rectangle1_type, String rectangle1_data, String rectangle2_image, String rectangle2_type, String rectangle2_data) {
        super();
        this.title = title;
    ...
    public static Home6Data newInstanceList(String json) {
        Home6Data bean = null;
        try {
            ...
            if (obj.length() > 0) {
                ...
                bean = new Home6Data(title, rectangle1_image, rectangle1_type, rectangle1_data, rectangle2_image, rectangle2_type, rectangle2_data);
            }
