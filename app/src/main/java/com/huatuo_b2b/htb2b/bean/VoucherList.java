...
public class VoucherList {
    ...
    public VoucherList(String voucher_id, String voucher_code,
                       ...
                       String voucher_t_customimg, String voucher_state_text) {
        super();
    ...
    public static ArrayList<VoucherList> newInstanceList(String jsonDatas) {
        ...
        try {
            ...
            for (int i = 0; i < size; i++) {
                ...
                bean.add(new VoucherList(voucher_id, voucher_code, voucher_title, voucher_desc, voucher_start_date, voucher_end_date, voucher_price, voucher_limit, voucher_order_id, voucher_store_id, store_name, store_id, store_domain, voucher_t_customimg, voucher_state_text));
            }
    ...
    public String toString() {
        return "VoucherList [voucher_id=" + voucher_id + ", voucher_code="
                + voucher_code + ", voucher_title=" + voucher_title
                + ", voucher_desc=" + voucher_desc
                + ", voucher_start_date=" + voucher_start_date
                + ", voucher_end_date=" + voucher_end_date
                + ", voucher_price=" + voucher_price + ", voucher_limit="
                + voucher_limit + ", voucher_order_id=" + voucher_order_id
