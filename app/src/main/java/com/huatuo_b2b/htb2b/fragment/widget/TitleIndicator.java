...
public class TitleIndicator extends LinearLayout implements View.OnClickListener,
    ...
    private static final int FOOTER_COLOR = 0xff00aeff;
    ...
    public TitleIndicator(Context context, AttributeSet attrs) {
        ...
        mTextColorNormal = a.getColor(R.styleable.TitleIndicator_textColorNormal, 0xffffff);
        mTextColorSelected = a.getColor(R.styleable.TitleIndicator_textColorSelected, 0xffffff);
    ...
    public static void updateChildNotifys(int postion, int notifys, boolean hasPoint) {
        if (instance == null) {
            return;
        }
        View child = instance.getChildAt(postion);
